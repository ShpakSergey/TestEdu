...
public class Airport {
    ...
    public List<PassengerPlane> getPasPlaner() {
        List<PassengerPlane> listOfPassengersPlanes = new ArrayList<>();
        for (Plane plane : this.planes) {if (plane instanceof PassengerPlane) {listOfPassengersPlanes.add((PassengerPlane) plane);}}
    ...
    public PassengerPlane getPassengerPlaneWithMaxPassengersCapacity() {
        List<PassengerPlane> passengerPlanes = getPasPlaner();
